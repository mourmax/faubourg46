    ...
    const handleDownload = async () => {
        ...
        try {
            if (isInvoice && lead.invoice) {
                ...
                link.href = url;
                link.download = `Facture_${lead.invoice.invoiceNumber}_${lead.selection.contact.name.replace(/\s+/g, '_')}.pdf`;
                ...
                <Card className="bg-white p-8 md:p-12 border-none shadow-2xl rounded-[3rem] text-center space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-neutral-500 text-sm font-medium">
                            Votre {isInvoice ? 'facture' : 'estimation'} est prête à être téléchargée.
                        </p>
                    </div>
                    ...
                    <div className="py-8 border-y border-neutral-50 flex flex-col items-center gap-4">
                        <Button
                            ...
                            disabled={downloading || (isInvoice && !lead.invoice)}
