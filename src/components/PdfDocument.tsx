...
export const PdfDocument = ({ selection, quote, reference, catalogueFormulas, catalogueOptions }: PdfDocumentProps) => (
    <Document>
        <Page size="A4" style={styles.page}>
            ...
            {/* Bank Info (RIB / IBAN) */}
            <View wrap={false} style={{ marginTop: 20, padding: 12, backgroundColor: '#F9F9F9', borderRadius: 8, border: '1px solid #EEE' }}>
                ...
                <Text style={{ fontSize: 8, color: '#B8860B', fontWeight: 'bold', marginTop: 8, textAlign: 'center', backgroundColor: '#FFF', padding: 4, borderRadius: 4 }}>
                    Merci d'indiquer "Nom réservation + Date" dans le libellé de votre virement.
                </Text>
            </View>
            ...
            {/* Footer */}
            <Text style={styles.footer}>FAUBOURG 46 - 46 cours sextius 13100 aix en Provence - SIRET: 84752154900026 - TVA: FR77847521549 - Tél: 04 66 21 02 49</Text>
        </Page>
    </Document>
);
